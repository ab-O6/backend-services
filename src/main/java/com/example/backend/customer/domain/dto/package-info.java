/**
 * Data transfer objects for the Customer module.
 * <p>
 ...
 * <p>
 * Other modules may reference this interface via {@code customer :: dtos} in their
 * {@link org.springframework.modulith.ApplicationModule#allowedDependencies() allowedDependencies}.
 * <p>
 * Other modules should use these DTOs when interacting with the Customer module's API.
 */
@org.springframework.modulith.NamedInterface("dtos")
package com.example.backend.customer.domain.dto;
