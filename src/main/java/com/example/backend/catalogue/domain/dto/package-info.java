/**
 * Data transfer objects for the Catalogue module.
 * <p>
 ...
 * <p>
 * Other modules may reference this interface via {@code catalogue :: dtos} in their
 * {@link org.springframework.modulith.ApplicationModule#allowedDependencies() allowedDependencies}.
 * <p>
 * Other modules should use these DTOs when interacting with the Catalogue module's API.
 */
